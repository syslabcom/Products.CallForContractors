# -*- coding: utf-8 -*-
"""
This module contains the tool of Products.CallForContractors
"""
import os
...
long_description = (
    ...
    '**********************\n'
    + '\n' +
    read('Products', 'CallForContractors', 'README.txt')
    + '\n' +
    'Contributors\n'
    '************\n'
    + '\n' +
...
setup(name='Products.CallForContractors',
      ...
      url='https://svn.syslab.com/svn/OSHA/Products.CallForContractors',
      license='GPL + EUPL',
